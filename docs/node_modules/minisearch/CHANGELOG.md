...
- _Breaking change_: default tokenizer splits by Unicode space or punctuation
...
- _Breaking change_: default term processing does not discard 1-character
    words.

- _Breaking change_: auto suggestions by default perform prefix search only on
