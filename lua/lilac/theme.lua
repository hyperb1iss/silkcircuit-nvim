...
function M.get_highlights(colors, opts)
  ...
  highlights.NormalFloat = { fg = colors.fg, bg = opts.transparent and colors.none or colors.bg_highlight }
  highlights.NormalNC = opts.dim_inactive and { fg = colors.fg, bg = colors.bg_dark } or { link = "Normal" }
